...
public class BootstrapConfig {
    @Bean
    public RequestAccounts getRequestAccounts(ObtainAccounts obtainAccounts, AccountReader accountReader) {
        return new AccountDomain(obtainAccounts, accountReader);
    }
